...
VALUES
((SELECT id FROM "USER" WHERE "email" = 'wXlTq@hexschooltest.io'), (SELECT id FROM "COURSE" WHERE user_id = (SELECT id FROM "USER" WHERE "email" = 'lee2000@hexschooltest.io')), '即將授課', '2024-11-24 16:00:00'),
((SELECT id FROM "USER" WHERE "email" = 'richman@hexschooltest.io'), (SELECT id FROM "COURSE" WHERE user_id = (SELECT id FROM "USER" WHERE "email" = 'lee2000@hexschooltest.io')), '即將授課', '2024-11-24 16:00:00');
